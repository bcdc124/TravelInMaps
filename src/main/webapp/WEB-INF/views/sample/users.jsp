  ...
  <div class="user-info">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="avatar">
            <img src="/resources/assets/images/user-avatar.jpg" alt="">
  ...
  <section class="portfolio">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="thumb">
            <img src="/resources/assets/images/portfolio-05.jpg" alt="">
            <div class="hover-effect">
              <div class="content">
        ...
        <div class="col-lg-3">
          <div class="thumb">
            <img src="/resources/assets/images/portfolio-06.jpg" alt="">
            <div class="hover-effect">
              <div class="content">
        ...
        <div class="col-lg-5">
          <div class="thumb">
            <img src="/resources/assets/images/portfolio-07.jpg" alt="">
            <div class="hover-effect">
              <div class="content">
        ...
        <div class="col-lg-3">
          <div class="thumb">
            <img src="/resources/assets/images/portfolio-08.jpg" alt="">
            <div class="hover-effect">
              <div class="content">
        ...
        <div class="col-lg-4">
          <div class="thumb">
            <img src="/resources/assets/images/portfolio-09.jpg" alt="">
            <div class="hover-effect">
              <div class="content">
                <h4>Walk In The Forest</h4>
                <span>Ranked: <em>3rd</em></span>
