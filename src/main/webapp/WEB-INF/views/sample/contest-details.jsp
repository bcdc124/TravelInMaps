      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="waiting-item">
            <img src="/resources/assets/images/waiting-01.jpg" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="waiting-item">
            <img src="/resources/assets/images/waiting-02.jpg" alt="">
            <div class="down-content">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="waiting-item">
            <img src="/resources/assets/images/waiting-03.jpg" alt="">
            <div class="down-content">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="waiting-item">
            <img src="/resources/assets/images/waiting-04.jpg" alt="">
            <div class="down-content">
