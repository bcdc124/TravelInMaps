    ...
    <div class="container">
      <div class="row">
        <div class="col-lg col-sm-4">
          <div class="item">
            <div class="icon">
              <img src="/resources/assets/images/icon-01.png" alt="">
            </div>
        ...
        <div class="col-lg col-sm-4">
          <div class="item">
            <div class="icon">
              <img src="/resources/assets/images/icon-02.png" alt="">
            </div>
            <h4>Space Contest</h4>
            <span>Available Contests</span>
        ...
        <div class="col-lg col-sm-4">
          <div class="item">
            <div class="icon">
              <img src="/resources/assets/images/icon-03.png" alt="">
            </div>
        ...
        <div class="col-lg col-sm-4">
          <div class="item">
            <div class="icon">
              <img src="/resources/assets/images/icon-04.png" alt="">
            </div>
            <h4>Nature Picture</h4>
            <span>Available Contests</span>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="item">
            <div class="thumb">
              <img src="/resources/assets/images/featured-image-02.jpg" alt="">
              <div class="hover-effect">
                <div class="content">
                  ...
                  <div class="info">
                    <span class="participants"><img src="/resources/assets//images/icon-03.png" alt=""><br>60<br>Participants</span>
                    <span class="submittions"><img src="/resources/assets//images/icon-01.png" alt=""><br>188<br>Submissions</span>
                  </div>
                  <div class="border-button">
                    <a href="/sample/contest-details">Browse Nature Contests</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          <div class="item">
            <div class="thumb">
              <img src="/resources/assets/images/featured-image-01.jpg" alt="">
              <div class="hover-effect">
                <div class="content">
                  <div class="top-content">
                    <span class="award">Award Price</span>
                  ...
                  <h4>Walk In The Nature Night</h4>
                  <div class="info">
                    <span class="participants"><img src="/resources/assets//images/icon-03.png" alt=""><br>78<br>Participants</span>
                    <span class="submittions"><img src="/resources/assets//images/icon-01.png" alt=""><br>240<br>Submissions</span>
                  </div>
                  <div class="border-button">
                    <a href="/sample/contest-details">Browse Nature Contests</a>
                  </div>
        ...
        <div class="col-lg-4">
          <div class="item">
            <div class="thumb">
              <img src="/resources/assets/images/featured-image-03.jpg" alt="">
              <div class="hover-effect">
                <div class="content">
                  <div class="top-content">
                    <span class="award">Award Price</span>
                  ...
                  <h4>Walk In The Nature Night</h4>
                  <div class="info">
                    <span class="participants"><img src="/resources/assets//images/icon-03.png" alt=""><br>112<br>Participants</span>
                    <span class="submittions"><img src="/resources/assets//images/icon-01.png" alt=""><br>286<br>Submissions</span>
                  </div>
                  <div class="border-button">
                    <a href="/sample/contest-details">Browse Nature Contests</a>
                  </div>
        ...
        <div class="col-lg-4">
          <div class="item">
            <div class="thumb">
              <img src="/resources/assets/images/featured-image-04.jpg" alt="">
              <div class="hover-effect">
                <div class="content">
                  <div class="top-content">
                    <span class="award">Award Price</span>
                  ...
                  <h4>Walk In The Nature Night</h4>
                  <div class="info">
                    <span class="participants"><img src="/resources/assets//images/icon-03.png" alt=""><br>54<br>Participants</span>
                    <span class="submittions"><img src="/resources/assets//images/icon-01.png" alt=""><br>140<br>Submissions</span>
                  </div>
                  <div class="border-button">
                    <a href="/sample/contest-details">Browse Nature Contests</a>
                  </div>
        ...
        <div class="col-lg-4">
          <div class="item">
            <div class="thumb">
              <img src="/resources/assets/images/featured-image-05.jpg" alt="">
              <div class="hover-effect">
                <div class="content">
                  <div class="top-content">
                    <span class="award">Award Price</span>
                  ...
                  <h4>Walk In The Nature Night</h4>
                  <div class="info">
                    <span class="participants"><img src="/resources/assets//images/icon-03.png" alt=""><br>68<br>Participants</span>
                    <span class="submittions"><img src="/resources/assets//images/icon-01.png" alt=""><br>162<br>Submissions</span>
                  </div>
                  <div class="border-button">
                    <a href="/sample/contest-details">Browse Nature Contests</a>
                  </div>
          ...
          <div class="owl-testimonials owl-carousel">
            <div class="item">
              <div class="content">
                ...
                <div class="image">
                  <img src="/resources/assets/images/author.jpg" alt="">
                </div>
              </div>
            </div>
            <div class="item">
          ...
          <div class="clients">
            <div class="row">
              <div class="col-lg-2 col-4">
                <img src="/resources/assets/images/contest-01.jpg" alt="">
              </div>
              <div class="col-lg-2 col-4">
                <img src="/resources/assets/images/contest-02.jpg" alt="">
              </div>
              <div class="col-lg-2 col-4">
                <img src="/resources/assets/images/contest-01.jpg" alt="">
              </div>
