          ...
          <div class="header-text">
            ...
            <div class="buttons">
              <div class="big-border-button">
                <a href="/sample/contests">Explore SnapX Contest</a>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="main-button">
            <a href="/sample/categories">Discover All Categories</a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="thumb">
              <img src="/resources/assets/images/popular-01.png" alt="">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="thumb">
              <img src="/resources/assets/images/popular-02.png" alt="">
              <span class="category">Top Contest</span>
              <span class="likes"><i class="fa fa-heart"></i> 256</span>
            </div>
            <div class="border-button">
              <a href="/sample/contest-details">Browse Random Pic Contests</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="thumb">
              <img src="/resources/assets/images/popular-03.png" alt="">
              <span class="category">Top Contest</span>
              <span class="likes"><i class="fa fa-heart"></i> 256</span>
            </div>
            <div class="border-button">
              <a href="/sample/contest-details">Browse Portrait Pic Contests</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="thumb">
              <img src="/resources/assets/images/popular-04.png" alt="">
              <span class="category">Top Contest</span>
              <span class="likes"><i class="fa fa-heart"></i> 256</span>
            </div>
            <div class="border-button">
              <a href="/sample/contest-details">Browse Space Pic Contests</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
          ...
          <div class="owl-features owl-carousel" style="position: relative; z-index: 5;">
            <div class="item">
              <div class="closed-item">
                <div class="thumb">
                  <img src="/resources/assets/images/closed-01.jpg" alt="">
            ...
            <div class="item">
              <div class="closed-item">
                <div class="thumb">
                  <img src="/resources/assets/images/closed-02.jpg" alt="">
                  <span class="winner"><em>Winner:</em> Anthony Soft</span>
            ...
            <div class="item">
              <div class="closed-item">
                <div class="thumb">
                  <img src="/resources/assets/images/closed-03.jpg" alt="">
                  <span class="winner"><em>Winner:</em> Anthony Soft</span>
        ...
        <div class="col-lg-12">
          <div class="border-button text-center">
            <a href="/sample/contests">Browse Open Contests</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="pricing-item">
            <img src="/resources/assets/images/pricing-01.jpg" alt="">
            <h4>Basic Plan</h4>
            <ul class="first-plan">
        ...
        <div class="col-lg-4">
          <div class="pricing-item">
            <img src="/resources/assets/images/pricing-02.jpg" alt="">
            <h4>Standard Plan</h4>
        ...
        <div class="col-lg-4">
          <div class="pricing-item">
            <img src="/resources/assets/images/pricing-03.jpg" alt="">
            <h4>Advanced Plan</h4>
            <ul class="third-plan">
              <li>Lorem Ipsum Dolores Sonte</li>
              <li>Songe Lorem Ipsum Dol</li>
